...
public class DatabaseFiller
{
    ...
    private static List<UserModel> BuildUsers()
    {
        ...
        return new List<UserModel>
        {
            ...
            new() { Name = "Mark", LastName = "Dekker", Email = "nokhaiangel@gmail.com", Password = "a", Address = "newstraat 12", Zipcode = "2234LB", PhoneNumber = "3143257897", Birthdate = new DateTime(random.Next(1950, 2005), random.Next(1, 13), random.Next(1, 29)), City = "Rotterdam" },
